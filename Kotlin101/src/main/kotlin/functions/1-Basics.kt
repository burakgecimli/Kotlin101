...
fun main(): Unit {
    ...
    //  basics.kekod2022.lesson10.getType missmatch hatasını alırız.
    ...
    getUserInfo1(*arrayOf("basics.kekod2022.lesson09.boo", "foo", "", ""), key = 2)
...
/*
fun basics.kekod2022.lesson09.getUserInfo(vararg userInfo: String, vararg userInfo2: String) {
    userInfo[3]
