...
fun main() {
     ...
     * Int.extToString() metodu basics.kekod2022.lesson10.Shape sınıfına yazılmıştır dolayısı ile basics.kekod2022.lesson10.Shape sınıfı dışında erişilemez.
     */

    // 34.extToString() Bu kod hata verir extToString basics.kekod2022.lesson10.Shape classında olduğu için erişim yapamayız.
...
open class Shape {
    ...
    open fun Int.extToString() {
        ...
        //ama biz bu extToString i sadece basics.kekod2022.lesson10.Shape class i icinde kullanabiliriz. Butun projede kullanmayiz.
        //butun projede ext fun kullanmak istiyorsak kt dosyasinda class disinda yazmamiz gerekiyor.


        // basics.kekod2022.lesson10.Shape'e ait asagidaki sekilde uye methodu isaret ederiz.
 ...
 * **/
var Shape.type
    get() = "basics.kekod2022.lesson10.Rectangle"
    set(value) {
        type = value
    }
