 ...
 * The property basics.kekod2022.lesson10.getType is optional if it can be inferred from the initializer or the getter's return basics.kekod2022.lesson10.getType, as shown below:
 */

var initialized = 1 // has basics.kekod2022.lesson10.getType Int, default getter and setter
 ...
 */
fun main(){
    val simple: Int? // has basics.kekod2022.lesson10.getType Int, default getter, must be initialized in constructor
    val inferredType = 1 // has basics.kekod2022.lesson10.getType Int and a default getter
    var num:Int
